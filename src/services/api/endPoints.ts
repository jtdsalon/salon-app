...
export const GET_SALON_SETTINGS_URL = '/salons/{salonId}/settings'
export const UPDATE_SALON_SETTINGS_URL = '/salons/{salonId}/settings'
export const GET_SALON_BREAKS_URL = '/salons/{salonId}/breaks'
export const CREATE_SALON_BREAK_URL = '/salons/{salonId}/breaks'
export const DELETE_SALON_BREAK_URL = '/salons/{salonId}/breaks/{breakId}'
export const UPDATE_SALON_OPERATING_HOURS_URL = '/salons/{salonId}/operating-hours'
...
export const GET_STAFF_SCHEDULES_URL = '/staff/{id}/schedules'
export const UPDATE_STAFF_SCHEDULES_URL = '/staff/{id}/schedules'
