      ...
      >
        <Box>
          <Stack direction="row" alignItems="center" spacing={2}>
            <Typography variant="h3" sx={{ fontWeight: 900, mb: 1, color: isDark ? 'white' : '#0F172A' }}>
              ...
              {filteredCustomers.map((customer) => {
                ...
                return (
                  <TableRow key={customer.id} hover sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                    ...
                    <TableCell sx={{ py: 4, pl: 4 }}>
                      <Stack direction="row" spacing={3} alignItems="center">
                        <Avatar 
                          ...
                          sx={{ width: 56, height: 56, border: `2px solid ${isDark ? 'rgba(255,255,255,0.1)' : theme.palette.divider}` }} 
                        />
                        <Box>
                          <Typography sx={{ fontWeight: 800, fontSize: '1.1rem' }}>
                            {fullName}
                          </Typography>
                          <Typography sx={{ fontWeight: 800, fontSize: '10px', color: '#EAB308', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                            {tier} TIER
                          </Typography>
                        </Box>
                      </Stack>
                    ...
                    {/* Financials */}
                    <TableCell>
                      <Typography sx={{ fontWeight: 900, fontSize: '1.1rem', color: '#EAB308' }}>
                        Rs. {Number(customer.total_spent || 0).toLocaleString()}
                      </Typography>
                    </TableCell>
                        ...
                        <Tooltip title="View Aesthetic Journey">
                          <IconButton 
                            sx={{ 
                              ...
                              '&:hover': { color: '#EAB308', bgcolor: alpha('#EAB308', 0.1) } 
                            }}
                          >
